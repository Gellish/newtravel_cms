    ...
    <div class="container">
        ...
        <div class="container panel-body">
            ...
            <div class="col-md-3 text-center">
                <div class="row">
                    <br>
                    Powered and Built by Bizz-Manager
                </div>
            </div>
            <div class="col-md-2">
                <a href="http://bizz-manager.com" target="_blank"><img src="<?php echo $theme_url; ?>assets/img/footer-php.png" class="img-responsive" alt="Bizz-Manager" /></a>
            </div>
        </div>
