            ...
            <div class="item <?php echo $ms->sactive; ?> hero">
                ...
                <div class="container hidden-xs hidden-sm">
                    <div class="carousel-caption text-center">
                        <h5 data-wow-duration="1s" data-wow-delay="0.1s" style="color: white; font-weight: bold; font-size: 4.5vw; padding: 5px 0; display: inline-block;font-size:32px;" class="fadeInUp wow text-center"><?php echo $ms->title;?></h5>
                        <div class="clearfix"></div>
                        <p data-wow-duration="2s" data-wow-delay="0.1s" style="margin: -10px 0 10px;font-size:16px;" class="flash wow text-center"><?php echo $ms->desc;?></p>
                        <div class="clearfix"></div>
